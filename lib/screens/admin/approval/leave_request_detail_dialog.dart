...
/// Dialog hiển thị chi tiết đơn xin nghỉ phép và approve/reject
class LeaveRequestDetailDialog extends StatefulWidget {
  final LeaveRequestManagement request;

  const LeaveRequestDetailDialog({super.key, required this.request});

  @override
  State<LeaveRequestDetailDialog> createState() =>
      _LeaveRequestDetailDialogState();
}

class _LeaveRequestDetailDialogState extends State<LeaveRequestDetailDialog> {
  ...
  Future<void> _approve() async {
    ...
    try {
      await _apiService.approveLeaveRequest(
      ...
      if (mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('Đã phê duyệt đơn nghỉ phép'),
